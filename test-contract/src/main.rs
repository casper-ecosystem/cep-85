...
use casper_types::{
    bytesrepr::Bytes, runtime_args, system::auction::ARG_AMOUNT, CLType, ContractHash, EntryPoint,
...
use constants::{
    ...
    ENTRY_POINT_CHECK_SAFE_TRANSFER_FROM, ENTRY_POINT_CHECK_SET_APPROVAL_FOR_ALL,
...
pub extern "C" fn call() {
    ...
    runtime::put_key(CEP85_TEST_CONTRACT_NAME, Key::from(contract_hash));
