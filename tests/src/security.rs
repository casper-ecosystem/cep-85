...
use cep85::{
    constants::{
        ARG_ENABLE_MINT_BURN, ARG_EVENTS_MODE, ARG_NAME, ARG_URI, BURNER_LIST, MINTER_LIST,
        TOKEN_URI,
    },
    error::Cep85Error,
...
use crate::utility::{
    ...
    installer_request_builders::{
        cep85_burn, cep85_mint, cep85_set_total_supply_of, setup_with_args, TestContext,
    },
...
fn test_security_burner_rights() {
    ...
    let set_total_supply_of_call =
        cep85_set_total_supply_of(&mut builder, &cep85_token, minting_account, id, mint_amount);
