...
describe('CEP85Client Unit', () => {
  ...
  // describe('CEP85Client - transferFrom', () => {
  //   let client: CEP85Client;
  //   const key = PrivateKey.generate(KeyAlgorithm.ED25519);
  ...
  // describe('CEP85Client - increaseAllowance', () => {
  //   let client: CEP85Client;
  //   const key = PrivateKey.generate(KeyAlgorithm.ED25519);
  //   const spenderKey = PrivateKey.generate(KeyAlgorithm.ED25519);
  //   const mockParams: ApproveParams = {
  ...
  // describe('CEP85Client - decreaseAllowance', () => {
  //   let client: CEP85Client;
  //   const key = PrivateKey.generate(KeyAlgorithm.ED25519);
  //   const spenderKey = PrivateKey.generate(KeyAlgorithm.ED25519);
  ...
  //     const clientWithoutContractHash = new CEP85Client('http://mock-rpc-url');
  //     await expect(
  ...
  // describe('CEP85Client - allowances', () => {
  //   let client: CEP85Client;
  //   let mockRpcClient: RpcClient;
  ...
  //   let client: CEP85Client;
  //   const mockName = 'CEP85';
  //   const mockSymbol = 'CEP85';
