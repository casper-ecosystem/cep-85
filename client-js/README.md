...
As CEP-85 1.0 supports two events modes - `CEP47` and `CES` we have two parsers as a part of this SDK.

* Example usage of CEP47 parser

```
import { EventStream, EventName } from 'casper-js-sdk';
import { CEP47EventParserFactory, CEP47Events } from 'casper-cep85-js-sdk';
